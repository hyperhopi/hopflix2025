            ...
            <HoverCardTrigger asChild>
                <Card className="group relative overflow-hidden border-0 bg-card/60 shadow-sm transition-transform hover:scale-[1.03]">
                    <div className="relative aspect-video w-full">
                        ...
                        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,hsl(var(--primary)/0.20),transparent_55%)] opacity-80 group-hover:opacity-100 transition-opacity" />
